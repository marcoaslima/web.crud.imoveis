    ...
    ?>
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
                        <ul class="breadcrumb text-center">
							...
							<li>
                                <a href="http://www.marcolima.hol.es/tei/tarefa-4/index.php">Imóveis</a>
                            </li>
        ...
        <footer class="section section-primary">
            <div class="container">
				...
				<div class="row">
					<p style="text-align: center; color: white;">Todos os direitos reservados <a href="http://www.marcolima.hol.es" style="color: white;">Marco Aurélio Lima</a> e Michel Prince &copy; 2015</p>
				</div>
            </div>
        </footer>
