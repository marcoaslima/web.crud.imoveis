       ...
       <div class="navbar navbar-default navbar-default navbar-static-top navbar-fixed-top" style="margim-bottom: 40px; border-top-style: solid; border-top-width: 5px; border-top-color: #337CBB;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #337CBB;"><span><img src="img/home.png" style="height: 60px;" />&nbsp;IMÓVEIS MP</span></a>
                </div>
            ...
            <div class="container">
				...
				<div class="col-md-12">
                        <ul class="breadcrumb text-center">
                            <li>
                                <a href="http://www.marcolima.hol.es">Marco Lima</a>
                            </li>
                            <li>
                                <a href="http://www.marcolima.hol.es/#topicos">Tópicos Especiais</a>
                            </li>
							<li>
                                <a href="http://www.marcolima.hol.es/tei/tarefa-4/">Imóveis</a>
                            </li>
        ...
        <footer class="section section-primary">
            <div class="container">
				...
				<div class="row">
					<p style="text-align: center; color: white;">Todos os direitos reservados <a href="http://www.marcolima.hol.es" style="color: white;">Marco Aurélio Lima</a> e Michel Prince &copy; 2015 <a href="http://www.marcolima.hol.es/tei/docs/tarefa-4.zip" style="color: white;">Download desta tarefa</a></p>
				</div>
            </div>
        </footer>
